	...
	var app = {
		...
		decrement: function(){
			...
			if(this.timer < 0){
				this.stop();
				$("#chargement").text("0%");
				$("#compteur").html('<iframe width="560" height="315" src="https://www.youtube.com/embed/NcCo3bIUmkU?autoplay=1" frameborder="0" allowfullscreen></iframe>');
			}
		},
